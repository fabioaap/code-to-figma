 ...
 */
export function extractColorTokens(layers: FigmaNode[]): Record<string, string> {
 ...
 */
export function extractTypographyTokens(layers: FigmaNode[]): Record<string, TypographyToken> {
 ...
 */
export function extractSpacingTokens(layers: FigmaNode[]): Record<string, string> {
 ...
 */
export function flattenLayers(node: FigmaNode): FigmaNode[] {
 ...
 */
export function mapFigmaFrameToTokenSet(
  frameNode: FigmaNode,
